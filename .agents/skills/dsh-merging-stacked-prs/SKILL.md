...
description: Upstream GitHub stacked-PR reference. Invoke only when the user explicitly requests an upstream contribution or stacked-PR operation.
---


## Current branch scope

This Skill is retained as upstream engineering reference. It is not the default workflow for the independent research branch unless the user explicitly requests an upstream contribution or stacked-PR operation.
