...
description: Upstream push-validation reference. Invoke only when the user explicitly requests an upstream publication or contribution workflow.
---


## Current branch scope

This Skill is retained as upstream engineering reference. It is not the default workflow for the independent research branch; use focused local checks unless the user explicitly requests an upstream publication workflow.
